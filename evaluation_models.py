...
from trainAI_3 import Pclass, MultiLayerFCNet  # Assuming the class definitions are the same for all variants
from variant1 import MultiLayerFCNet as Variant1Net  # Variant 1 model class
from variant2 import MultiLayerFCNet as Variant2Net  # Variant 2 model class
import pandas as pd
